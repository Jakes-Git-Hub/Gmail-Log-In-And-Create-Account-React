...
interface BirthdayAndGenderComponentProps {
    month: string;
    handleSelectMonth: (event: SelectChangeEvent<string>) => void;
    day: string;
    handleSelectDay: (e: React.ChangeEvent<HTMLInputElement>) => void;
    year: string;
    handleSelectYear: (e: React.ChangeEvent<HTMLInputElement>) => void;
    gender: string;
    handleSelectGender: (e: SelectChangeEvent<string>) => void;
    handleNextClick: () => void;
    genderEmpty: boolean;
    errorCondition: string | null;
    isImageLoaded: boolean;
    customGender: string;
    handleSelectCustomGender: (e: React.ChangeEvent<HTMLInputElement>) => void;
    customGenderEmpty: boolean;
    pronounEmpty: boolean;
    pronoun: string;
    handleSelectPronoun: (e: SelectChangeEvent<string>) => void;
...
export const BirthdayAndGenderComponent: React.FC<BirthdayAndGenderComponentProps> = ({
    month, 
    handleSelectMonth,
    day,
    handleSelectDay,
