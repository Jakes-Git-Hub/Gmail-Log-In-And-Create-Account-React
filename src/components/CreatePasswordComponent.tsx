...
interface Props {
  ...
  handleSelectPassword: (e: ChangeEvent<HTMLInputElement>) => void;
  confirmPassword: string;
  handleSelectConfirmPassword: (e: ChangeEvent<HTMLInputElement>) => void;
  setConfirmPassword: Dispatch<SetStateAction<string>>;
  handleNextClick: () => void;
  showPassword: boolean;
  setShowPassword: Dispatch<SetStateAction<boolean>>;
  handleTogglePassword: () => void;
  confirmYourPassword: () => void;
  passwordMismatch: () => void;
...
export const CreatePasswordComponent: React.FC<Props> = ({
  password,
      ...
      <div id='google-container-responsive' data-testid='CP'>
        ...
        <form>
          ...
          <Box id='create-password-space' className='line-height label-input-width input-label'>
            <TextField
              fullWidth
              error={!!errorCondition && errorCondition !== 'confirmPasswordEmpty' && errorCondition !== 'passwordMismatch'}
              id='passwordInput'
              value={password}
          ...
          <Box className='space line-height label-input-width input-label' id='error-message-margin'>
            <TextField
              fullWidth
              error={!!errorCondition && errorCondition !== 'passwordEmpty' && errorCondition !== 'needs8CharsOrMore'}
          ...
          <div id='create-password-next-button' className='button-space-create-password'>
            ...
            >
              <div className='next'>{text.CreatePassword.next[userData.language]}</div>
            </CustomNextButton>
          </div>
        </form>
      </div>
