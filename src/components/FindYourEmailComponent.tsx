                ...
                <form>
                    ...
                    {errorCondition === 'phoneNumberOrEmailEmpty'  ? (
                        <div className='error-div'>
                            ...
                            <p className='input-error-message'>{text.FindYourEmail.validEmailOrPhone[userData.language]}</p>
                        </div>
                        ...
                        <div className='error-div'>
                            ...
                            <p className='input-error-message'>{text.FindYourEmail.validEmailOrPhoneWithPlease[userData.language]}</p>
                        </div>
                    ) : (
