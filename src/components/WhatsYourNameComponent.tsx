...
interface WhatsYourNameComponentProps {
  firstName: string;
  lastName: string;
  handleNextClick: () => void;
  onFirstNameInputChange: (e: React.ChangeEvent<HTMLInputElement>) => void;
  onLastNameInputChange: (e: React.ChangeEvent<HTMLInputElement>) => void;
...
export const WhatsYourNameComponent: React.FC<WhatsYourNameComponentProps> = ({
  firstName,
  lastName,
  handleNextClick,
      ...
      <main id='google-container-responsive' data-testid='WYN'>
        ...
        <form>
          ...
          <div className={errorCondition === 'firstNameEmpty' ? 'button-right-first-name-empty' : 'button-right-ca'}>
            ...
            >
              <div className='next'>{text.CreateAccount.next[userData.language]}</div>
            </CustomNextButton>
          </div>
        </form>
      </main>
