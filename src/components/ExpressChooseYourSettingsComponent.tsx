...
interface ExpressChooseYourSettingsComponentProps {
    handleNextClick: (e: React.MouseEvent<HTMLButtonElement>) => void;
    isImageLoaded: boolean;
    showWebAndAppActivityModal: boolean;
    closeWebAndAppActivityModal: () => void;
    openWebAndAppActivityModal: () => void;
    modalCondition: string;
    animationOpen: any;
    animationClose: any;
    showYouTubeHistoryModal: boolean;
    openYouTubeHistoryModal: () => void;
    closeYouTubeHistoryModal: () => void;
    openPersonalizedAdsModal: () => void;
    closePersonalizedAdsModal: () => void;
    showPersonalizedAdsModal: boolean;
    text: TextData | any;
    handleLanguageSelection: (chosenLanguage: string) => void;
    handleRejectAllClick: (e: React.MouseEvent<HTMLButtonElement>) => void;
    userData: {
        language: string;
        [key: string]: any;
    };
...
export const ExpressChooseYourSettingsComponent: React.FC<ExpressChooseYourSettingsComponentProps> = ({ 
    handleNextClick,
    isImageLoaded,
        ...
        <>
            ...
            <main className='google-container-flexible-ryai' id='ecys-top-margin' data-testid='ECYS'>
                ...
                <div id='choose-your-settings-title'>
                    <h1 className='thin h1-space'>{text.ExpressChooseYourSettings.h1[userData.language]}</h1>
                </div>

                <div id='express-choose-your-settings-info'>

                    <p className='pecys'>{text.ExpressChooseYourSettings.depending[userData.language]}</p>

                    <div className='settings-svg-and-info-container'>
                        <div className='settings-svg-and-info-row'>
                            <div className='svg-settings'>
                                <svg aria-hidden='true' className='setting-svg' focusable='false' width='24px' height='24px' viewBox='0 0 24 24' xmlns='https://www.w3.org/2000/svg'>
                            ...
                            <div className='info-settings'>
                                ...
                                <TransparentSmallButton 
                                    className='setting-information' 
                                    onClick={openWebAndAppActivityModal}
                                    aria-label='Open web and app activity modal'
                                >
                                        ...
                                        >
                                            ...
                                            <div className='modal-got-it-div'>
                                                <SecondaryGreyButton2 
                                                        ...
                                                        aria-label='Close web and app activity modal'
                                                        sx={{
                        ...
                        <div className='settings-svg-and-info-row'>
                            ...
                            <div className='info-settings'>
                                ...
                                <TransparentSmallButton 
                                    ...
                                    aria-label='Open YouTube history modal'
                                >
                                    {text.ExpressChooseYourSettings.learnMore2}
                                </TransparentSmallButton>
                                <Modal
                        ...
                        <div className='settings-svg-and-info-row'>
                            <div className='svg-settings'>
                            <svg aria-hidden='true' className='stUf5b' fill='currentColor' focusable='false' width='24px' height='24px' viewBox='0 0 24 24' xmlns='https://www.w3.org/2000/svg'><path fill-rule='evenodd' clip-rule='evenodd' d='M15.2222 11.1111H9.88889V12.8889H15.2222V11.1111ZM14.7138 16.4444H4.55556V14.6667H14.1868C14.3511 15.2415 14.5288 15.8374 14.7138 16.4444ZM15.2629 18.2222H3.66667C3.18667 18.2222 2.77778 17.9022 2.77778 17.5289V6.47111C2.77778 6.09778 3.18667 5.77778 3.66667 5.77778H16.1022C16.5822 5.77778 16.9911 6.09778 16.9911 6.47111V12H17V14.9042C17.2675 14.9865 17.5366 15.0696 17.8065 15.1528C18.1296 15.2525 18.4539 15.3526 18.7778 15.4522V6.47111C18.7778 5.11111 17.5689 4 16.1111 4H3.66667C2.20889 4 1 5.12 1 6.47111V17.5289C1 18.8889 2.20889 20 3.66667 20H15.8153C15.6668 19.5183 15.5152 19.0319 15.3636 18.5455C15.3301 18.4377 15.2965 18.3299 15.2629 18.2222ZM8.11111 12.8889H4.55556V7.55556H8.11111V12.8889ZM15.2222 9.33333H9.88889V7.55556H15.2222V9.33333Z' fill='#5F6368'></path><path d='M15 15C15.5409 16.9727 16.3682 19.3909 16.9091 21.3636L17.6982 18.9773L20.7273 22L22 20.7273L19.0091 17.7364L21.3636 16.9091C19.3909 16.3682 16.9727 15.5727 15 15Z' fill='#5F6368'></path></svg>
                            </div>
                            <div className='info-settings'>
                                <p className='pecys-pseudo-title'>{text.ExpressChooseYourSettings.personalizedAds}</p>
                                <p className='setting-information'>{text.ExpressChooseYourSettings.provides3}</p> 
                                <TransparentSmallButton 
                                    className='setting-information' 
                                    onClick={openPersonalizedAdsModal} 
                                    aria-label='Open personalized ads modal'
                                >
                                    {text.ExpressChooseYourSettings.learnMore3}
                                </TransparentSmallButton>
                                <Modal
                                    ...
                                    closeAfterTransition
                                    className='modal-ecys'
                                    aria-modal={showPersonalizedAdsModal ? 'true' : 'false'}
                                >
                                    <animated.div style={modalCondition === 'opening' ? animationOpen : modalCondition === 'closing' ? animationClose : {}}>
                                        <Box 
                                            sx={{
                    ...
                    <h2 className='express-ecys-h2'>{text.ExpressChooseYourSettings.whatData}</h2>
                    <p className='pecys p-gap-ecys'>{text.ExpressChooseYourSettings.datap1}</p>
                    <p className='pecys p-gap-ecys'>{text.ExpressChooseYourSettings.datap2}</p>
                    <p className='pecys p-gap-ecys-last'>{text.ExpressChooseYourSettings.datap3}</p>
                    <h2 className='express-ecys-h2'>{text.ExpressChooseYourSettings.howWeUse}</h2>
                    <p className='pecys'>{text.ExpressChooseYourSettings.howWeUse1}</p>
                    ...
                    <p className='pecys p-gap-ecys-first'>{text.ExpressChooseYourSettings.howWeUse5}</p>
                    <p className='pecys p-gap-ecys-tight'>{text.ExpressChooseYourSettings.howWeUse6}</p>
                    ...
                    <p className='pecys p-gap-ecys-first-and-last'>{text.ExpressChooseYourSettings.howWeUse9}</p>
                    <h2 className='express-ecys-h2'>{text.ExpressChooseYourSettings.howYouCan}</h2>
                    <p className='pecys p-gap-ecys'>{text.ExpressChooseYourSettings.howYouCan1}</p>
                    <p className='pecys p-gap-ecys-last'>{text.ExpressChooseYourSettings.howYouCan2}</p>
                
                </div>

                <div className='next-and-skip-button-duo button-space-ecys'>
                    <CustomNextAndSkipButton 
                        className='duo' 
                        variant='contained' 
                        onClick={handleRejectAllClick}
                        type='submit'
                        aria-label='Reject all settings button'
                        sx={{
                            '&& .MuiTouchRipple-rippleVisible': {
                                animationDuration: '300ms',
                            },
                    ...
                    <CustomNextAndSkipButton
                        ...
                        type='button'
                        aria-label='Accept all settings button'
                        sx={{
                            '&& .MuiTouchRipple-rippleVisible': {
                                animationDuration: '300ms',
                            },
