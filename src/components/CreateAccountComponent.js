...
var CreateAccountComponent = function (_a) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("main", { id: 'google-container-responsive', "data-testid": 'CA' },
            ...
            react_1.default.createElement("form", null,
                react_1.default.createElement("h1", { className: 'thin h1-space' }, text.CreateAccount.h1[userData.language]),
                react_1.default.createElement("h2", { className: 'thin gap' }, text.CreateAccount.h2[userData.language]),
                ...
                react_1.default.createElement(TextField_1.default, { label: text.CreateAccount.lastName[userData.language], className: 'last-name-margin-top standard-text-field', variant: 'outlined', fullWidth: true, value: lastName, onChange: onLastNameInputChange, "aria-label": 'Enter your last name', "aria-invalid": errorCondition ? 'true' : 'false', sx: {
                        '& .MuiOutlinedInput-root': {
                            '&:hover:not(.Mui-focused) fieldset': {
                                borderColor: '#dadce0'
                            },
                ...
                errorCondition === 'firstNameEmpty' ? (react_1.default.createElement("div", { className: 'error-div' },
                    ...
                    react_1.default.createElement("p", { className: 'input-error-message' }, text.CreateAccount.error1[userData.language]))) : errorCondition === 'areYouSureCorrect' ? (react_1.default.createElement("div", { className: 'error-div' },
                    react_1.default.createElement("svg", { "aria-hidden": 'true', className: 'error-image', fill: 'rgb(217, 48, 37)', focusable: 'false', width: '16px', height: '16px', viewBox: '0 0 24 24', xmlns: 'https://www.w3.org/2000/svg' },
                        react_1.default.createElement("path", { d: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z' })),
                    react_1.default.createElement("p", { className: 'input-error-message' }, text.CreateAccount.error2[userData.language]))) : (react_1.default.createElement("div", { className: 'hidden-error-message-container-create-account' })),
                react_1.default.createElement("div", { className: errorCondition === 'firstNameEmpty' || errorCondition === 'areYouSureCorrect' ? 'button-right-first-name-empty' : 'button-right-ca' },
        ...
        react_1.default.createElement(LanguageChangerComponent_1.default, { id: 'language-changer-footer', className: 'language-changer-div', onChange: handleLanguageSelection, initialLanguage: userData.language, "aria-label": 'Change language', text: text })));
};
