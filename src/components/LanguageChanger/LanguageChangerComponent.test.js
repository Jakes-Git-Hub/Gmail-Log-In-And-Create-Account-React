...
describe('LanguageChanger component', () => {
  test('renders without crashing', () => {
    const { getByTestId } = render(<LanguageChanger initialLanguage={mockUserData.language} onChange={mockOnChange}/>);
    const comboBox = getByTestId('language-changer-dropdown'); // Assuming this is the data-testid of the intended combobox
