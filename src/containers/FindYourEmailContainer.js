...
export const FindYourEmailContainer = ({ updateUser, text, userData, updateFindYourEmailCredentials, isWrongCredentials }) => {
    ...
    return (_jsx(_Fragment, { children: _jsx(FindYourEmailComponent, { handleNextClick: handleNextClick, errorCondition: errorCondition, handleLanguageSelection: handleLanguageSelection, text: text, isImageLoaded: isImageLoaded, onPhoneNumberOrEmailInputChange: onPhoneNumberOrEmailInputChange, userData: userData, phoneNumberOrEmail: phoneNumberOrEmail }) }));
};
