...
export const BirthdayAndGenderContainer = ({ updateUser, text, userData }) => {
    ...
    const [customGenderEmpty, setCustomGenderEmpty] = useState(false);
    const [pronoun, setPronoun] = useState('');
    const [pronounEmpty, setPronounEmpty] = useState(false);
